			...
			<form onSubmit={handleSubmit(onSubmit)} method='POST'>
				...
				<div className='flex flex-col gap-6 mt-10'>
					<div>
						<label
							htmlFor='email'
							className={`text-xs mb-2 ${errors?.email ? 'text-destructive' : ''}`}
						>
							Email address
						</label>
						<div className='relative'>
							...
							/>
							{errors?.email && (
								<p className='absolute top-1/2 right-4 -translate-y-1/2 text-destructive text-xs'>
					...
					<div>
						<label
							htmlFor='password'
							className={`text-xs mb-2 ${errors?.password ? 'text-destructive' : ''}`}
						>
							Create password
						</label>
						<div className='relative'>
					...
					<div>
						<label
							...
							className={`text-xs mb-2 ${errors?.confirmPassword ? 'text-destructive' : ''}`}
						>
							Confirm password
						</label>
						<div className='relative'>
